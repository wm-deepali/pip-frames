...
class BindingOrderCustomer extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Binding Order '.$binding_order->order_number.' From Book Empire')
                    ->view('emails.binding-order-customer')->with([
