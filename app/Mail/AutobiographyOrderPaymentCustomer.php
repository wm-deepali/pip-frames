...
class AutobiographyOrderPaymentCustomer extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Autobiography Order Payment '.$binding_order->order_number.' From Book Empire')
                    ->view('emails.autobiography-order-payment-customer')->with([
