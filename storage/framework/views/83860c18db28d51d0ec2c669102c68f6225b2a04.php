                ...
                <table class="table table-striped" id="extra-option-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="badge badge-<?php echo e($option->is_active ? 'success' : 'secondary'); ?>">
                          <?php echo e($option->is_active ? 'Yes' : 'No'); ?>

                        </span>
                      </td>
                      <td><?php echo e($option->sort_order); ?></td>
                      <td><?php echo e($option->created_at->format('d M Y')); ?></td>
                      <td>
                        <ul class="list-inline mb-0">
                          ...
                          <li class="list-inline-item">
                            <a href="javascript:void(0)" onclick="deleteExtraOptionConfirmation(<?php echo e($option->id); ?>)">
...
<script>
  ...
  $(document).ready(function () {
    ...
    $(document).on('click', '#add-extra-option', function () {
      ...
      $.get("<?php echo e(route('admin.extra_options.create')); ?>", function (result) {
        if (result.success) {
    ...
    $(document).on('click', '.edit-extra-option', function () {
      ...
      $.get(`<?php echo e(url('admin/extra_options')); ?>/${id}/edit`, function (result) {
        if (result.success) {
          $('#extra-option-modal').html(result.html).modal('show');
        }
      });
    ...
    $(document).on('click', '#save-extra-option-btn', function () {
      ...
      const url = `<?php echo e(url('admin/extra_options')); ?>`;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\pip_frames\resources\views/admin/extra_options/index.blade.php ENDPATH**/ ?>