                            ...
                            <?php if($contact): ?>
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr><th>Show on Header (Contact Number)</th><td><?php echo e($contact->show_on_header ? 'Yes' : 'No'); ?></td></tr>
                                        <tr><th>Show on Footer (Contact Number)</th><td><?php echo e($contact->show_on_footer ? 'Yes' : 'No'); ?></td></tr>

                                        <tr><th>Mobile Number</th><td><?php echo e($contact->mobile_number ?? 'N/A'); ?></td></tr>
                                        <tr><th>Show on Header (Mobile)</th><td><?php echo e($contact->show_on_header_mobile ? 'Yes' : 'No'); ?></td></tr>
                                        <tr><th>Show on Footer (Mobile)</th><td><?php echo e($contact->show_on_footer_mobile ? 'Yes' : 'No'); ?></td></tr>

                                        <tr><th>Email</th><td><?php echo e($contact->email ?? 'N/A'); ?></td></tr>
                                        <tr><th>Show on Header (Email)</th><td><?php echo e($contact->show_on_header_email ? 'Yes' : 'No'); ?></td></tr>
                                        <tr><th>Show on Footer (Email)</th><td><?php echo e($contact->show_on_footer_email ? 'Yes' : 'No'); ?></td></tr>
