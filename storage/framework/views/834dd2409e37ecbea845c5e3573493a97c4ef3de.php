...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group form-check mb-3">
                        <input type="checkbox" id="subscribe" name="subscribe" class="form-check-input"
                               <?php echo e(old('subscribe') ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select id="countrySelect" name="country" class="form-control <?php $__errorArgs = ['country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <?php $__currentLoopData = $deliveryCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="delivery-<?php echo e($charge->id); ?>" name="delivery_charge_id"
                                       ...
                                       value="<?php echo e($charge->id); ?>"
                                    <?php echo e(old('delivery_charge_id', $deliveryCharges->firstWhere('is_default', true)?->id) == $charge->id ? 'checked' : ''); ?>>
                                    ...
                                    <tr>
                                        <td>
                                            <?php if(!empty($item['photos'][0])): ?>
                                                <img src="<?php echo e(asset('storage/' . $item['photos'][0])); ?>" alt="Product" style="width:60px;"><br>
                                            <?php endif; ?>
                                            <?php $__currentLoopData = $entry['attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div style="font-size:0.9rem;">
                                                    <strong><?php echo e($attribute['name']); ?>:</strong> <?php echo e($attribute['value']); ?>
