                    ...
                    <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="option-card1 <?php echo e($loop->first ? 'active' : ''); ?>" data-id="<?php echo e($subcategory->id); ?>"
                                data-name="<?php echo e($subcategory->name); ?>" onclick="selectSubcategory(this)">
                                <img src="<?php echo e(asset('storage/' . ($subcategory->thumbnail ?? ''))); ?>"
                                    alt="<?php echo e($subcategory->name ?? ''); ?>">

                            </div>
                            <p class="text-center"><?php echo e($subcategory->name ?? ''); ?></p>
                        </div>
                ...
                <div class="step-content">
                    ...
                    <div class="step-box" id="step-5" style="display:none; width:90%;">
                        ...
                        <div style="margin-bottom:36px;">
                            <?php $__currentLoopData = $extraOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label style="display:flex; align-items:flex-start; cursor:pointer; margin-bottom:12px;">
                                    <input type="checkbox" name="extra_options[]" value="<?php echo e($option->id); ?>"
                                        data-price="<?php echo e($option->price); ?>"
                                        style="accent-color:#ff3b7c; width:20px; height:20px; margin-right:8px; margin-top:2px;">
                                    <div>
                                        <span style="font-weight:bold;">
                                            <?php echo e($option->title); ?> &nbsp; + &nbsp; £<?php echo e(number_format($option->price, 2)); ?>
    ...
    align-items: center;">
            ...
            <div class="col-12 col-lg-6 right-part text-center">
                ...
                <div class="thumbnails" id="thumbnails-container">
                    <?php if($subcategories->first()->gallery): ?>
                        <?php $__currentLoopData = $subcategories->first()->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <img src="<?php echo e(asset('storage/' . $image)); ?>" onclick="changeImage(this)" alt="Thumbnail" />
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </div>
...
<script>
    const subcategoryGalleries = <?php echo json_encode($subcategories->mapWithKeys(function ($subcategory) {
        return [$subcategory->id => $subcategory->gallery ?? []];
    }), 15, 512) ?>;

    const subcategoryThumbnails = <?php echo json_encode($subcategories->mapWithKeys(function ($subcategory) {
    ...
    function updateMainImage() {
        ...
        if (mainFrameAttr) {
            ...
            if (orientation === 'portrait') {
                ...
                if (frameImg) {
                    console.log('frameOverlayPortrait', frameOverlayPortrait);
...
</script><?php /**PATH D:\web-mingo-project\pip_frames\resources\views/front/calculator.blade.php ENDPATH**/ ?>