      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group">
          ...
          <select name="step_number" class="form-control">
            ...
            <option value="1" <?php echo e($subcategoryAttribute->step_number == 1 ? 'selected' : ''); ?>>Step 1</option>
            <option value="2"<?php echo e($subcategoryAttribute->step_number == 2 ? 'selected' : ''); ?>>Step 2</option>
            <option value="3" <?php echo e($subcategoryAttribute->step_number == 3 ? 'selected' : ''); ?>>Step 3</option>
...
</script><?php /**PATH D:\web-mingo-project\pip_frames\resources\views/admin/subcategory-attributes/edit.blade.php ENDPATH**/ ?>