...
<?php $__env->startSection('content'); ?>
			...
			<div class="banner-carousel owl-theme owl-carousel">
				...
				<div class="slide">
					<div class="image-layer"
						style="background-image:url(<?php echo e(asset('site_assets')); ?>/images/slides/slide-v1-1.jpg)"></div>
					<div class="auto-container">
						<div class="content">
							...
							<div class="btns-box">
								...
								<a class="btn-one marleft style2" href="#"><span class="txt">987-876-876-87</span></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="slide">
					<div class="image-layer"
						style="background-image:url(<?php echo e(asset('site_assets')); ?>/images/slides/slide-v1-2.jpg)"></div>
					<div class="auto-container">
						<div class="content">
							<h5>//<span>Enjoy Your Holiday</span>//</h5>
							<h2>We Keep Them<br> Happy Anytime<span class="round"></span></h2>
				...
				<div class="slide">
					<div class="image-layer"
						style="background-image:url(<?php echo e(asset('site_assets')); ?>/images/slides/slide-v1-3.jpg)"></div>
					<div class="auto-container">
						<div class="content">
							<h5>//<span>Enjoy Your Holiday</span>//</h5>
							<h2>We Keep Them<br> Happy Anytime<span class="round"></span></h2>
				...
				<div class="col-xl-7">
					<div class="about-style1-image-box">
						<div class="about-style1-image-box-bg"
							style="background-image: url(<?php echo e(asset('site_assets')); ?>/images/shape/about-style1-image-box-bg.png)">
						</div>
						<div class="main-image">
							<img src="<?php echo e(asset('site_assets')); ?>/images/about/about-1.png" alt="Awesome Image">
						</div>
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="<?php echo e(asset('site_assets')); ?>/images/services/service-v1-1.jpg" alt="">
							</div>
						</div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="<?php echo e(asset('site_assets')); ?>/images/services/service-v1-2.jpg" alt="">
							</div>
						</div>
						<div class="text-holder">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="<?php echo e(asset('site_assets')); ?>/images/services/service-v1-3.jpg" alt="">
							</div>
						</div>
						<div class="text-holder">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="<?php echo e(asset('site_assets')); ?>/images/services/service-v1-4.jpg" alt="">
							</div>
						</div>
						<div class="text-holder">
			...
			<div class="row">
				<div class="col-xl-6">
					<div class="video-gallery-content-box text-center">
						<img src="<?php echo e(asset('site_assets')); ?>/images/resources/video-gallery-image.png" alt="">
				...
				<div class="col-xl-6">
					<div class="video-holder-box text-center"
						style="background-image: url(<?php echo e(asset('site_assets')); ?>/images/resources/video-gallery-bg.jpg)">
			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="working-hours-box"
						style="background-image: url(<?php echo e(asset('site_assets')); ?>/images/resources/working-hours-box-bg.jpg)">
						<div class="inner-content">
							<div class="title">
	...
	<section class="testimonial-style1-area">
		<div class="image-box1"><img src="<?php echo e(asset('site_assets')); ?>/images/testimonial/testimonial-image-1.png" alt="">
		</div>
				...
				<div class="col-xl-12 col-lg-12">
					<div class="testimonial-carousel owl-carousel owl-theme">
						...
						<div class="single-testimonial-style1  wow fadeInUp" data-wow-delay="100ms"
							...
							<div class="img-holder">
								<img src="<?php echo e(asset('site_assets')); ?>/images/testimonial/tes-v1-1.png" alt="Awesome Image">
							</div>
							<div class="text-holder">
					...
					<div class="blog-carousel owl-carousel owl-theme owl-nav-style-one">
						...
						<div class="single-blog-style1 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
							<div class="img-holder">
								...
								<div class="inner">
									<img src="<?php echo e(asset('site_assets')); ?>/images/blog/blog-v1-1.jpg" alt="Awesome Image">
								</div>
							</div>
							<div class="text-holder">
								<ul class="meta-info">
						...
						<div class="single-blog-style1 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
							<div class="img-holder">
								...
								<div class="inner">
									<img src="<?php echo e(asset('site_assets')); ?>/images/blog/blog-v1-2.jpg" alt="Awesome Image">
								</div>
							</div>
							<div class="text-holder">
								<ul class="meta-info">
						...
						<div class="single-blog-style1 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
							<div class="img-holder">
								...
								<div class="inner">
									<img src="<?php echo e(asset('site_assets')); ?>/images/blog/blog-v1-3.jpg" alt="Awesome Image">
								</div>
							</div>
							<div class="text-holder">
								<ul class="meta-info">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.new-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\pip_frames\resources\views/front/index.blade.php ENDPATH**/ ?>