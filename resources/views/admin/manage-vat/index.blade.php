                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <button class="btn btn-sm btn-danger"
                                                                onclick="deleteValue({{ $item->id }})">Delete</button>
                                                        </div>
                                                    </td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#add-manage-vat', function () {
                $.get("{{ route('admin.manage-vat.create') }}", function (result) {
                    if (result.success) {
            ...
            $(document).on('click', '.edit-manage-vat', function () {
                ...
                $.get(`{{ url('admin/manage-vat') }}/${id}/edit`, function (result) {
                    if (result.success) {
                        $('#manage-vat-modal').html(result.html).modal('show');
            ...
            $(document).on('click', '#save-manage-vat-btn', function () {
                ...
                const id = $(this).data("id");
                const url = id ? `{{ url('admin/manage-vat') }}/${id}` : `{{ url('admin/manage-vat') }}`;
