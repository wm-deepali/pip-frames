...
@section('content')
 ...
 <div class="form-check mt-1">
                                            <input type="checkbox" name="show_on_header" value="1" class="form-check-input"
                                                id="show_on_header"  {{ old('show_on_header', $contact->show_on_header) ? 'checked' : '' }}>
                                            <label for="show_on_header" class="form-check-label">Show on Header</label>
                                        </div>
                                         <div class="form-check mt-1">
                                            <input type="checkbox" name="show_on_footer" value="1"
                                                class="form-check-input" id="show_on_footer" {{ old('show_on_footer', $contact->show_on_footer) ? 'checked' : '' }}>
                                        ...
                                        <div class="invalid-feedback" id="error-mobile_number"></div>
                                          <div class="form-check mt-1">
                                            <input type="checkbox" name="show_on_header_mobile" value="1" class="form-check-input"
                                                id="show_on_header_mobile" {{ old('show_on_header_mobile', $contact->show_on_header_mobile) ? 'checked' : '' }}>
                                         ...
                                         <div class="form-check mt-1">
                                            <input type="checkbox" name="show_on_footer_mobile" value="1"
                                                class="form-check-input" id="show_on_footer_mobile"  {{ old('show_on_footer_mobile', $contact->show_on_footer_mobile) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="invalid-feedback" id="error-email"></div>
                                         <div class="form-check mt-1">
                                            <input type="checkbox" name="show_on_header_email" value="1"
                                                class="form-check-input" id="show_on_header_email"  {{ old('show_on_header_email', $contact->show_on_header_email) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mt-1">
                                            ...
                                            <label for="show_on_footer_email" class="form-check-label" {{ old('show_on_footer_email', $contact->show_on_footer_email) ? 'checked' : '' }}>Show on
                                                Footer</label>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="full_address" id="full_address" class="form-control"
                                            rows="3">{{ old('full_address', $contact->full_address) }}</textarea>
