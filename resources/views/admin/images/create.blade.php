            ...
            <div class="col-12">
              <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('admin.images.index') }}">Image Settings</a></li>
      ...
      <div class="content-body">
        <div class="card">
              ...
              <div class="form-group">
                ...
                <select name="subcategory_id" class="form-control" id="subcategory-select">
                  ...
                  @foreach($subcategories as $subcategory)
                    <option value="{{ $subcategory->id }}" {{ old('subcategory_id', $condition->subcategory_id ?? '') == $subcategory->id ? 'selected' : '' }}>
                      {{ $subcategory->name }}
                    </option>
                  @endforeach
                </select>
          ...
          <div class="card-footer text-right">
            ...
            <button type="submit" class="btn btn-primary">{{ isset($condition) ? 'Update' : 'Save' }}</button>
          </div>
          </form>
        </div>
      </div>
