...
<head>
  ...
  <title>{{ $meta ? $meta->title : 'Book Printer | Book Publishers, Printing and Binding UK' }}</title>
  <meta name="keywords" content="{{ $meta ? $meta->keywords : 'Book Printer | Book Publishers, Printing and Binding UK' }}">
  <meta name="description" content="{{ $meta ? $meta->description : 'Book Printer | Book Publishers, Printing and Binding UK' }}">
  
  <meta property="og:locale" content="{{ $meta ? $meta->og_locale : '' }}" />
  <meta property="og:type" content="{{ $meta ? $meta->og_type : '' }}" />
  <meta property="og:title" content="{{ $meta ? $meta->og_title : '' }}" />
  <meta property="og:image" content="{{ $meta ? $meta->og_image : '' }}"/>
  <meta property="og:description" content="{{ $meta ? $meta->og_description : '' }}"/>
  <meta property="og:url" content="{{ $meta ? $meta->og_tag : '' }}"/>
  <meta property="og:site_name" content="{{ $meta ? $meta->og_site_name : '' }}" />

  <meta property="article:publisher" content="{{ $meta ? $meta->publisher : '' }}" />

  <meta name="twitter:card" content="{{ $meta ? $meta->twitter_card : '' }}"/>
  <meta name="twitter:description" content="{{ $meta ? $meta->twitter_description : '' }}"/>
  <meta name="twitter:title" content="{{ $meta ? $meta->twitter_title : '' }}"/>
  <meta name="twitter:site" content="{{ $meta ? $meta->twitter_site : '' }}"/>
  <meta name="twitter:domain" content="{{ $meta ? $meta->twitter_tag_url : '' }}"/>
  <meta name="twitter:creator" content="{{ $meta ? $meta->twitter_creator : '' }}"/>
  <meta name="twitter:image" content="{{ $meta ? $meta->twitter_image : '' }}">

  <link rel="canonical" href="{{ $meta ? $meta->canonical_link : '' }}" />

  <link href="{{ asset('site_assets') }}/images/favicon.png" rel="icon">
  <link href="{{ asset('site_assets') }}/css/bootstrap.min.css" rel="stylesheet">
  <link href="{{ asset('site_assets') }}/css/all.min.css" rel="stylesheet">
  <!--<link href="{{ asset('site_assets') }}/css/bootstrap-icons.css" rel="stylesheet">
  <link href="{{ asset('site_assets') }}/css/boxicons.min.css" rel="stylesheet">-->
  ...
  <link href="{{ asset('site_assets') }}/css/price.css" rel="stylesheet">
<link href="{{ asset('site_assets/css/price-online-shop.css') }}" rel="stylesheet">
...
<body>
  ...
  <script async src="{{ asset('site_assets') }}/js/iconify.min.js"></script>
  <script async src="{{ asset('site_assets') }}/js/sweetalert.min.js"></script>
  <script async src="{{ asset('site_assets') }}/js/jquery.validate.js"></script>
  <script async src="{{ asset('site_assets') }}/js/additional-methods.min.js"></script>
  <script src="{{ asset('site_assets') }}/js/owl.carousel.min.js"></script>
  <script async src="{{ asset('site_assets') }}/js/bootstrap.bundle.min.js"></script>
  <script async src="{{ asset('site_assets') }}/js/purecounter.js"></script>
  <script async src="{{ asset('site_assets') }}/js/lightbox.min.js"></script>
  <script async src="{{ asset('site_assets') }}/js/main.js"></script>
    ...
    submitHandler: function(form) {
     $.ajaxSetup({
      ...
      document.getElementById("requestCallbackForm").reset(); 
            return window.location = "{{ url('/thankyou') }}";
            $('#res_message').show();
