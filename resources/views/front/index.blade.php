			...
			<div class="banner-carousel owl-theme owl-carousel">
				...
				<div class="slide">
					<div class="image-layer desktop-slider"
						style="background-image:url({{ asset('site_assets') }}/images/slides/slide1.png)"></div>
					<div class="image-layer mobile-slider"
						style="background-image:url({{ asset('site_assets') }}/images/slides/mobile-slider1.png)"></div>
							...
							<div class="btns-box">
								...
								@if($firstCategory)
									<a class="btn-one" href="{{ route('category.show', $firstCategory->slug) }}">
										<span class="txt" style="color:#fff;">{{ $firstCategory->name }} &nbsp;<i
				...
				<div class="slide">
					<div class="image-layer desktop-slider"
						style="background-image:url({{ asset('site_assets') }}/images/slides/slide2.png)"></div>
					<div class="image-layer mobile-slider"
						style="background-image:url({{ asset('site_assets') }}/images/slides/mobile-slider2.png)"></div>
					<div class="auto-container">
						<div class="content">
				...
				<div class="slide">
					<div class="image-layer desktop-slider"
						style="background-image:url({{ asset('site_assets') }}/images/slides/slide3.png)"></div>
					<div class="image-layer mobile-slider"
						style="background-image:url({{ asset('site_assets') }}/images/slides/mobile-slider3.png)"></div>
					<div class="auto-container">
						<div class="content">
							<!--	<h5>//<span>Custom Portraits of Pets, People & More</span>//</h5> -->
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="{{ asset('site_assets') }}/images/water-color-frame.png" alt="People Portraits">
							</div>
						</div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="{{ asset('site_assets') }}/images/line-frame.png" alt="Pet Portraits">
							</div>
						</div>
						<div class="text-holder">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="{{ asset('site_assets') }}/images/pop-frame.png" alt="Custom Illustrations">
							</div>
						</div>
						<div class="text-holder">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
					<div class="single-service-style1">
						<div class="img-holder">
							<div class="inner">
								<img src="{{ asset('site_assets') }}/images/cartoon-frame.png" alt="Custom Illustrations">
							</div>
						</div>
						<div class="text-holder">
					...
					<div class="testimonial-carousel owl-carousel owl-theme">
						...
						@foreach($testimonials as $testimonial)
							<div class="single-testimonial-style1 wow fadeInUp" data-wow-delay="100ms"
								...
								<div class="img-holder">
									<img src="{{   $testimonial->author_image ? asset('storage/' . $testimonial->author_image) : asset('site_assets/images/testimonial/tes-v1-1.png') }}"
										alt="Customer Image">
								</div>
								<div class="text-holder">
