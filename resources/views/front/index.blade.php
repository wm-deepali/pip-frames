			...
			<div class="banner-carousel owl-theme owl-carousel">
				...
				<div class="slide">
					<div class="image-layer"
						style="background-image:url({{ asset('site_assets') }}/images/slides/slide-v1-1.jpg)"></div>
				...
				<div class="slide">
					<div class="image-layer"
						style="background-image:url({{ asset('site_assets') }}/images/slides/slide-v1-2.jpg)"></div>
					<div class="auto-container">
						<div class="content">
							<h5>//<span>Enjoy Your Holiday</span>//</h5>
							<h2>We Keep Them<br> Happy Anytime<span class="round"></span></h2>
				...
				<div class="slide">
					<div class="image-layer"
						style="background-image:url({{ asset('site_assets') }}/images/slides/slide-v1-3.jpg)"></div>
					<div class="auto-container">
						<div class="content">
							<h5>//<span>Enjoy Your Holiday</span>//</h5>
							<h2>We Keep Them<br> Happy Anytime<span class="round"></span></h2>
