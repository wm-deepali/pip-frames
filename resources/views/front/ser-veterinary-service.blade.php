                ...
                <div class="col-xl-12">
                    <div class="inner-content clearfix text-center">
                        <div class="title wow slideInUp animated" data-wow-delay="0.3s" data-wow-duration="1500ms">
                            <h2>Veterinary Service<span class="dotted"></span></h2>
                        </div>
                        ...
                        <div class="service-details-categories">
                            ...
                            <div class="categories-box">
                                <ul class="categories clearfix">
                                    ...
                                    <li class="active"><a href="ser-veterinary-service.html">Veterinary Service</a></li>
                                </ul>
                            </div>
                        </div>

                        <div class="callto-action-box text-center"
                            style="background-image: url({{ asset('site_assets') }}/images/resources/callto-action-box-bg.jpg)">
                            <p>Call To Action</p>
