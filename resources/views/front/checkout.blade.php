                            ...
                            @foreach($deliveryCharges as $charge)
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="delivery-{{ $charge->id }}" name="delivery_charge_id"
                                        class="custom-control-input" value="{{ $charge->id }}" {{ old('delivery_charge_id', $deliveryCharges->firstWhere('is_default', true)?->id) == $charge->id ? 'checked' : '' }}>
                                            ...
                                            <tr>
                                                <td>
                                                    @if(!empty($item['photos'][0]))
                                                        <img src="{{ asset('storage/' . $item['photos'][0]) }}" alt="Product"
                                                            style="width:60px;"><br>
                                                    @endif
                                                            ...
                                                            <span>
                                                                <ul class="mb-0 pl-3">
                                                                    @foreach($entry['extra_options'] as $opt)
                                                                        <li style="font-size:0.9rem;">{{ $opt['title'] }}
                                                                            (+£{{ number_format($opt['price'], 2) }})</li>
                                                                    @endforeach
                                                                </ul>
                                                            </span>
                                                        @endif
