                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="right" width="70%" style="text-align: right;">
                                    <h2 style="font-size: 1.4em;font-weight: normal; margin: 0; color: #AB8818;">ONLINE BOOK ORDER</h2>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="right" width="50%" style="text-align: right;">
                                    <h2 style="font-size: 2.4em;font-weight: normal; margin: 0 0 10px 0; color: #AB8818;">Book Order</h2>
                            ...
                            <tr>
                                <td align="left" width="50%" style="text-align: left; border-left:6px solid #AB8818; padding-left: 6px; ">
                                    ...
                                    <p style="color:#000; font-size:24px; margin:8px 0;">
                                        {{ $binding_order->autobiography_binding_type->name ?? '-' }}-<span style="color: #888;">{{ $binding_order->autobiography_colour->name ?? '-' }}</span>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                ...
                <td>
                    <table border-spacing="0" style=" background: #fff; padding: 15px 0;" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="left" width="50%" style="text-align: left; border-left:6px solid #AB8818; padding-left: 6px; ">
                                    <h2 style="font-size: 1.4em;font-weight: normal; margin: 0; color: #AB8818;">Paper Type </h2>
                                    <p style="color:#000; font-size:24px; margin:8px 0;">
                                        {{ $binding_order->paper_type }}
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                ...
                <td>
                    <table border-spacing="0" style=" background: #fff; padding: 15px 0;" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="left" width="50%" style="text-align: left; border-left:6px solid #AB8818; padding-left: 6px; ">
                                    <h2 style="font-size: 1.4em;font-weight: normal; margin: 0; color: #AB8818;">Book Size </h2>
                                    <p style="color:#000; font-size:24px; margin:8px 0;">
                                        {{ Str::title(str_replace('_', ' ', $binding_order->book_size)) }}
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td align="left" width="50%" style="text-align: left; border-left:6px solid #AB8818; padding-left: 6px; ">
                                    ...
                                    <p style="color:#000; font-size:24px; margin:8px 0;">Paper Grade-<span style="color: #888;">{{ Str::title($binding_order->autobiography_paper_grade->name ?? '-') }}</span></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
