! function(e, n, a) {
  ...
  a.app.menu = {
    ...
    container: null,
    horizontalMenu: !1,
    is_touch_device: function() { var a = " -webkit- -moz- -o- -ms- ".split(" "); return !!("ontouchstart" in e || e.DocumentTouch && n instanceof DocumentTouch) || function(n) { return e.matchMedia(n).matches }(["(", a.join("touch-enabled),("), "heartz", ")"].join("")) },
    manualScroller: {
      obj: null,
      init: function() {
      ...
      update: function() {
        if (!0 === a(".main-menu").data("scroll-to-active")) {
          ...
          setTimeout((function() { a.app.menu.container.stop().animate({ scrollTop: o }, 300), a(".main-menu").data("scroll-to-active", "false") }), 300)
        }
      },
      enable: function() { a(".main-menu-content").hasClass("ps") || this.init() },
      disable: function() { this.obj && this.obj.destroy() },
      updateHeight: function() { "vertical-menu" != i.data("menu") && "vertical-menu-modern" != i.data("menu") && "vertical-overlay-menu" != i.data("menu") || !a(".main-menu").hasClass("menu-fixed") || (a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight() - a(".main-menu-footer").outerHeight()), this.update()) }
    },
    init: function(e) {
    ...
    update: function() { this.manualScroller.update() },
    reset: function() { this.expanded = !1, this.collapsed = !1, this.hidden = !1, i.removeClass("menu-hide menu-open menu-collapsed menu-expanded") }
  }, a.app.nav = {
    ...
    config: { speed: 300 },
    init: function(e) { this.initialized = !0, a.extend(this.config, e), this.bind_events() },
    bind_events: function() {
      ...
      a(".navigation-main").on("mouseenter.app.menu", "li", (function() {
        ...
        if (i.hasClass("menu-collapsed") && "vertical-menu-modern" != i.data("menu")) {
          ...
          e.hasClass("has-sub") || (n = e.find("span.menu-title").text(), t = e.children("a").attr("href"), "" !== n && ((o = a("<a>")).attr("href", t), o.attr("title", n), o.text(n), o.addClass("menu-title"))), s = e.css("border-top") ? e.position().top + parseInt(e.css("border-top"), 10) : e.position().top, "vertical-compact-menu" !== i.data("menu") && o.appendTo(".main-menu-content").css({ position: "fixed", top: s })
        }
      })).on("mouseleave.app.menu", "li", (function() {})).on("active.app.menu", "li", (function(e) { a(this).addClass("active"), e.stopPropagation() })).on("deactive.app.menu", "li.active", (function(e) { a(this).removeClass("active"), e.stopPropagation() })).on("open.app.menu", "li", (function(n) {
        var t = a(this);
        ...
        if ("vertical-menu-modern" == i.data("menu") && (a(".main-menu, .navbar-header").addClass("expanded"), i.hasClass("menu-collapsed"))) {
          ...
          e.children("ul").hide().slideDown(200, (function() { a(this).css("display", "") })), e.addClass("open").removeClass("menu-collapsed-open")
        }
        ...
        i.hasClass("menu-collapsed") && "vertical-menu-modern" == i.data("menu") && setTimeout((function() {
          if (0 === a(".main-menu:hover").length && 0 === a(".navbar-header:hover").length && (a(".main-menu, .navbar-header").removeClass("expanded"), i.hasClass("menu-collapsed"))) {
            var e = a(".main-menu li.open"),
              n = e.children("ul");
            e.addClass("menu-collapsed-open"), n.show().slideUp(200, (function() { a(this).css("display", "") })), e.removeClass("open")
          }
        }), 1)
      })), a(".main-menu-content").on("mouseleave", (function() { i.hasClass("menu-collapsed") && (a(".main-menu-content").children("span.menu-title").remove(), a(".main-menu-content").children("a.menu-title").remove(), a(".main-menu-content").children("ul.menu-content").remove()), a(".hover", ".navigation-main").removeClass("hover") })), a(".navigation-main li.has-sub > a").on("click", (function(e) { e.preventDefault() }))
    },
    collapse: function(e, n) {
      var t = e.children("ul"),
        i = e.children().first(),
        s = a(i).outerHeight();
      e.css({ height: s + t.outerHeight() + "px", overflow: "hidden" }), e.addClass("menu-item-animating"), e.addClass("menu-item-closing"), a.app.nav._bindAnimationEndEvent(e, (function() { e.removeClass("open"), a.app.nav._clearItemStyle(e) })), setTimeout((function() { e.css({ height: s + "px" }) }), 50)
    },
    expand: function(e, n) {
      var t = e.children("ul"),
        i = e.children().first(),
        s = a(i).outerHeight();
      e.addClass("menu-item-animating"), e.css({ overflow: "hidden", height: s + "px" }), e.addClass("open"), a.app.nav._bindAnimationEndEvent(e, (function() { a.app.nav._clearItemStyle(e) })), setTimeout((function() { e.css({ height: s + t.outerHeight() + "px" }) }), 50)
    },
    _bindAnimationEndEvent(n, t) {
      n = n[0];
      var i = function(e) { e.target === n && (a.app.nav._unbindAnimationEndEvent(n), t(e)) };
      let s = e.getComputedStyle(n).transitionDuration;
      s = parseFloat(s) * (-1 !== s.indexOf("ms") ? 1 : 1e3), n._menuAnimationEndEventCb = i, a.app.nav.TRANSITION_EVENTS.forEach((function(e) { n.addEventListener(e, n._menuAnimationEndEventCb, !1) })), n._menuAnimationEndEventTimeout = setTimeout((function() { i({ target: n }) }), s + 50)
    },
    _unbindAnimationEndEvent(e) {
      var n = e._menuAnimationEndEventCb;
      e._menuAnimationEndEventTimeout && (clearTimeout(e._menuAnimationEndEventTimeout), e._menuAnimationEndEventTimeout = null), n && (a.app.nav.TRANSITION_EVENTS.forEach((function(a) { e.removeEventListener(a, n, !1) })), e._menuAnimationEndEventCb = null)
    },
    _clearItemStyle: function(e) { e.removeClass("menu-item-animating"), e.removeClass("menu-item-closing"), e.css({ overflow: "", height: "" }) },
    refresh: function() { a.app.nav.container.find(".open").removeClass("open") }
  }
